...
export class Convert {
    public static toOrders(json: string): Orders[] {
        return cast(JSON.parse(json), a(r("Orders")));
    }

    public static ordersToJson(value: Orders[]): string {
        return JSON.stringify(uncast(value, a(r("Orders"))), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Product": o([
        ...
        { json: "listImage", js: "listImage", typ: a(r("ListImage")) },
        { json: "categoryName", js: "categoryName", typ: null },
